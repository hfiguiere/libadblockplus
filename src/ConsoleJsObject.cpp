...
{
  obj->SetProperty("log", GetPrivateImpl(jsEngine)->NewCallback(::LogCallback));
  obj->SetProperty("debug", GetPrivateImpl(jsEngine)->NewCallback(::DebugCallback));
  obj->SetProperty("info", GetPrivateImpl(jsEngine)->NewCallback(::InfoCallback));
  obj->SetProperty("warn", GetPrivateImpl(jsEngine)->NewCallback(::WarnCallback));
  obj->SetProperty("error", GetPrivateImpl(jsEngine)->NewCallback(::ErrorCallback));
  obj->SetProperty("trace", GetPrivateImpl(jsEngine)->NewCallback(::TraceCallback));
  return obj;
}
